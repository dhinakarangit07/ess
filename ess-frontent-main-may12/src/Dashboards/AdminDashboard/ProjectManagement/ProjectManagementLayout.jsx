...
const TopNav = () => {
  const navItems = [
    {
      to: "/admin/project-management/project",
      label: "Projects",
      icon: <FolderKanban className="w-5 h-5" />,
    },
    {
      to: "/admin/project-management/task",
      label: "Task",
      icon: <ListTodo className="w-5 h-5" />,
    },
    {
      to: "/admin/project-management/team-creation",
      label: "Team",
  ...
  return (
    <nav className="bg-white shadow-sm">
      <div className="flex items-center justify-between p-4 border-b">
        <h2 className="text-lg font-semibold text-gray-800">Project Management Dashboard</h2>

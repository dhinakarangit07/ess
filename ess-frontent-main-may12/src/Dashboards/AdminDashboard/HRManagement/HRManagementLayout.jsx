...
const TopNav = () => {
  const navItems = [
    { to: ".", label: "HR Management", icon: <Users className="w-5 h-5" />, end: true },
    { to: "attendance", label: "HR Attendance", icon: <UserCheck className="w-5 h-5" /> },
    { to: "attendance-reset", label: "HR Attendance Reset", icon: <UserCog className="w-5 h-5" /> },
    { to: "chart", label: "HR Statistics", icon: <ChartArea className="w-5 h-5" /> },
    { to: "hr-leave", label: "HR Leave Status", icon: <Briefcase className="w-5 h-5" /> },

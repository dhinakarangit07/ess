...
const menuItems = [
  {
    ...
    icon: <FaHome />,
    children: [
      { label: "Dashboard",path: "/employee/billing" },
      { label: "Parties", path: "/employee/billing" },
    ],
  },
  // {
  //   title: "ITEMS",
  //   icon: <FaBox />,
  //   children: [
  //     { label: "Inventory", className: "text-xl font-semibold mb-4",path: "/employee/billing/itemspage" },
  ...
  // },
  {
    ...
    icon: <FaShoppingCart />,
    children: [
      { label: "Sales Invoices", path: "/employee/billing/sales-invoice" },
      { label: "Quotation / Estimate", path: "/employee/billing/quotation-estimate" },
      { label: "Payment In", path: "/employee/billing/payment-in" },
      //{ label: "Sales Return", path: "/salesreturn" },
      { label: "Credit Note", path: "/employee/billing/credit-invoice" },
      { label: "Delivery Challan", path: "/employee/billing/delivery-challen" },
      { label: "Proforma Invoice", path: "/employee/billing/invoice" },
    ],
  },
  // {
  //   title: "Purchases",

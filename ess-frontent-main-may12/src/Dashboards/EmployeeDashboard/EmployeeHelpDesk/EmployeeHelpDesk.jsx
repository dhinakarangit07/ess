    ...
    <div className="relative w-[140px]">
      ...
      <div className="flex justify-between relative z-10">
        ...
        <div className="flex flex-col items-center">
          <div
            className={`w-6 h-6 rounded-full flex items-center justify-center 
            ${isReview || isApproved ? "bg-yellow-500" : "bg-gray-300"}`}
          >
...
const TicketForm = ({ isOpen, onClose, selectedService, services }) => {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 mt-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* New dropdown: Who are we raising this ticket to */}
            <div>
              ...
              <Select>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="supervisor1">User 1</SelectItem>
                  <SelectItem value="supervisor2">User 2</SelectItem>
                  <SelectItem value="supervisor3">User 3</SelectItem>
                </SelectContent>
              </Select>
            </div>
...
const EditTicketDialog = ({ isOpen, onClose, ticket }) => {
  const [title, setTitle] = useState("");
...
function ManagerHelpDeskComponent() {
  ...
  const services = [
    { 
      ...
      options: [
        ...
        { value: "unshift_related", label: "Unshift related" },
    ...
    { 
      ...
      options: [
        ...
        { value: "troble_shoot", label: "Troble shoot" },
  ...
  return (
    <div className="w-full">
      ...
      {/* Ticket Form Dialog */}
      <TicketForm isOpen={ticketPopup} onClose={() => setTicketPopup(false)} selectedService={selectedService} services={services} />
...
// Main Page Component that includes all the Manager Help Desk functionality

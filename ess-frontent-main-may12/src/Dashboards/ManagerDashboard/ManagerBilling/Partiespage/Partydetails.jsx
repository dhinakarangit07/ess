...
useEffect(() => {
  ...
  const handleSelectParty = (partyIdOrIndex) => {
    navigate(`/manager/billing/party-details/${partyIdOrIndex}`);
  };

 
  const handleEditParty = () => {
    if (!party) return;
    navigate(`/manager/billing/create-party?editId=${party.id}`);
  };
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="text-right">
                ...
                <button
                  onClick={(e) => {
                    e.preventDefault();
                    navigate(`/manager/billing/create-party?editId=${party.id}&manageShipping=1`);
                  }}
